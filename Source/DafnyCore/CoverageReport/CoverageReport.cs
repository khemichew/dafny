...
{
    internal class Schemata265
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT265");
        ...
        internal static bool ReplaceBinExprOp_0(long mutantId, Microsoft.Dafny.Program argument1, object argument2)
        {
...
namespace Microsoft.Dafny
{
    public class CoverageReport
    {
        ...
        public CoverageReport(string name, string units, string suffix, Program program)
        {
            ...
            labelsByFile = new();
            modulesByFile = new();
            if (MutateCSharp.Schemata265.ReplaceBinExprOp_0(1L, program, null))
            {
