...
{
    internal class Schemata430
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT430");
        ...
        internal static bool ReplaceBinExprOp_14(long mutantId, System.Numerics.BigInteger argument1, System.Numerics.BigInteger argument2)
        {
        ...
        internal static bool ReplaceBooleanConstant_19(long mutantId, bool argument1)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1; }
            if (ActivatedMutantId.Value == mutantId + 0) { return !argument1; }
            return argument1;
        ...
        internal static bool ReplaceBinExprOp_13(long mutantId, System.Numerics.BigInteger argument1, int argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 1)) { return argument1 < argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 1) { return argument1 != argument2; }
        ...
        internal static bool ReplaceBinExprOp_16(long mutantId, Microsoft.Dafny.UnaryOpExpr.Opcode argument1, Microsoft.Dafny.UnaryOpExpr.Opcode argument2)
        {
        ...
        internal static bool ReplaceBinExprOp_3(long mutantId, Microsoft.Dafny.BoundVar argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_10(long mutantId, Microsoft.Dafny.AttributedToken argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 != argument2; }
            return argument1 == argument2;
        ...
        internal static bool ReplaceBinExprOp_18(long mutantId, Microsoft.Dafny.DPreType argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
...
namespace Microsoft.Dafny
{
    public class UnderspecificationDetector : ResolverPass
    {
        ...
        public void Check(List<TopLevelDecl> declarations)
        {
            ...
            foreach (TopLevelDecl d in declarations)
            {
                ...
                if (d is IteratorDecl)
                {
                    ...
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_0(1L, prevErrCnt, ErrorCount))
                    {
                        iter.SubExpressions.ForEach(e => CheckExpression(e, context));
                    }
                    CheckParameterDefaultValues(iter.Ins, context);
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_1(6L, iter.Body, null))
                    {
                        CheckStatement(iter.Body, context);
                        if (MutateCSharp.Schemata430.ReplaceBinExprOp_0(7L, prevErrCnt, ErrorCount))
                        {
                            CheckStatement(iter.Body, context);
                        }
                    }
                ...
                else if (d is SubsetTypeDecl)
                {
                    ...
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_2(12L, dd.Witness, null))
                    {
                ...
                else if (d is NewtypeDecl)
                {
                    ...
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_3(13L, dd.Var, null))
                    {
                        ...
                        CheckExpression(dd.Constraint, context);
                        if (MutateCSharp.Schemata430.ReplaceBinExprOp_2(14L, dd.Witness, null))
                        {
                            CheckExpression(dd.Witness, context);
                        }
                    }
                ...
                else if (d is DatatypeDecl)
                {
                    ...
                    foreach (var member in resolver.GetClassMembers(dd)!.Values)
                    {
                        ...
                        {
                            var rolemodel = dtor.CorrespondingFormals[MutateCSharp.Schemata430.ReplaceNumericConstant_4(15L, 0)];
                            for (int i = MutateCSharp.Schemata430.ReplaceNumericConstant_4(19L, 1); MutateCSharp.Schemata430.ReplaceBinExprOp_5(23L, i, dtor.CorrespondingFormals.Count); MutateCSharp.Schemata430.ReplacePostfixUnaryExprOp_6(28L, ref i))
                            {
                                var other = dtor.CorrespondingFormals[i];
                                if (!Type.Equal_Improved(rolemodel.Type, other.Type))
                                {
                                    ReportError(other.tok,
                  MutateCSharp.Schemata430.ReplaceStringConstant_7(29L, "shared destructors must have the same type, but '{0}' has type '{1}' in constructor '{2}' and type '{3}' in constructor '{4}'"),
                                      rolemodel.Name, rolemodel.Type, dtor.EnclosingCtors[MutateCSharp.Schemata430.ReplaceNumericConstant_4(30L, 0)].Name, other.Type, dtor.EnclosingCtors[i].Name);
                                }
                                else if (MutateCSharp.Schemata430.ReplaceBinExprOp_8(34L, () => rolemodel.IsGhost, () => other.IsGhost))
                                {
                                    ReportError(other.tok,
                  MutateCSharp.Schemata430.ReplaceStringConstant_7(40L, "shared destructors must agree on whether or not they are ghost, but '{0}' is {1} in constructor '{2}' and {3} in constructor '{4}'"),
                                      rolemodel.Name,
                                      rolemodel.IsGhost ? MutateCSharp.Schemata430.ReplaceStringConstant_7(41L, "ghost") : MutateCSharp.Schemata430.ReplaceStringConstant_7(42L, "non-ghost"), dtor.EnclosingCtors[MutateCSharp.Schemata430.ReplaceNumericConstant_4(43L, 0)].Name,
                                      other.IsGhost ? MutateCSharp.Schemata430.ReplaceStringConstant_7(47L, "ghost") : MutateCSharp.Schemata430.ReplaceStringConstant_7(48L, "non-ghost"), dtor.EnclosingCtors[i].Name);
                                }
                            }
                        }
                    }
        ...
        private void CheckMember(MemberDecl member)
        {
            ...
            {
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_2(49L, field.Rhs, null))
                {
                    CheckExpression(field.Rhs, context);
                }
                CheckPreType(field.PreType, context, field.tok, MutateCSharp.Schemata430.ReplaceStringConstant_7(50L, "const"));
            ...
            else if (member is Method method)
            {
                ...
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_1(51L, method.Body, null))
                {
                    CheckStatement(method.Body, context);
                }
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_0(52L, errorCount, ErrorCount))
                {
            ...
            else if (member is Function function)
            {
                ...
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_2(57L, function.Body, null))
                {
                    CheckExpression(function.Body, context);
                }
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_0(58L, errorCount, ErrorCount))
                {
                    if (function is ExtremePredicate { PrefixPredicate: { } prefixPredicate })
                    {
                        CheckMember(prefixPredicate);
                    }
                    else if (MutateCSharp.Schemata430.ReplaceBinExprOp_9(63L, function.ByMethodDecl, null))
                    {
        ...
        private void CheckParameterDefaultValues(List<Formal> formals, UnderspecificationDetectorContext context)
        {
            ...
            {
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_2(64L, formal.DefaultValue, null))
                {
    ...
    public class DetectUnderspecificationVisitor : BottomUpVisitor
    {
        ...
        protected override void VisitOneStmt(Statement stmt)
        {
            if (stmt is VarDeclStmt)
            {
                ...
                {
                    CheckPreTypeIsDetermined(local.Tok, local.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(65L, "local variable"));
            ...
            else if (stmt is VarDeclPattern)
            {
                ...
                s.LocalVars.ForEach(local => CheckPreTypeIsDetermined(local.Tok, local.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(66L, "local variable")));
            ...
            else if (stmt is ForallStmt)
            {
                ...
                s.BoundVars.ForEach(bv => CheckPreTypeIsDetermined(bv.tok, bv.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(67L, "bound variable")));
            ...
            else if (stmt is AssignSuchThatStmt)
            {
                ...
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_10(68L, s.AssumeToken, null))
                {
        ...
        protected override void VisitOneExpr(Expression expr)
        {
            ...
            if (expr is LiteralExpr)
            {
                ...
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_12(70L, () => PreTypeResolver.IsBitvectorName(familyDeclName), () => MutateCSharp.Schemata430.ReplaceBinExprOp_11(69L, familyDeclName, PreType.TypeNameORDINAL)))
                {
                    var n = (BigInteger)e.Value;
                    var absN = MutateCSharp.Schemata430.ReplaceBinExprOp_13(80L, n, MutateCSharp.Schemata430.ReplaceNumericConstant_4(76L, 0)) ? -n : n;
                    // For bitvectors, check that the magnitude fits the width
                    if (PreTypeResolver.IsBitvectorName(familyDeclName, out var width) && MutateCSharp.Schemata430.ReplaceBinExprOp_14(82L, ConstantFolder.MaxBv(width), absN))
                    {
                        cus.ReportError(e.tok, MutateCSharp.Schemata430.ReplaceStringConstant_7(84L, "literal ({0}) is too large for the bitvector type {1}"), absN, e.PreType);
                    }
                    ...
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_12(93L, () => MutateCSharp.Schemata430.ReplaceBinExprOp_13(89L, n, MutateCSharp.Schemata430.ReplaceNumericConstant_4(85L, 0)), () => MutateCSharp.Schemata430.ReplaceBinExprOp_11(92L, e.tok.val, MutateCSharp.Schemata430.ReplaceStringConstant_7(91L, "-0"))))
                    {
                        Contract.Assert(e.tok.val == "-0");  // this and the "if" above tests that "n < 0" happens only when the token is "-0"
                        cus.ReportError(e.tok, MutateCSharp.Schemata430.ReplaceStringConstant_7(99L, "unary minus (-{0}, type {1}) not allowed in case pattern"), absN, e.PreType);
                    }
                }

                if (expr is StaticReceiverExpr stexpr)
                {
                    CheckPreTypeIsDetermined(stexpr.tok, stexpr.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(100L, "static receiver"));
                }
            ...
            else if (expr is ComprehensionExpr)
            {
                ...
                {
                    CheckVariable(bv, MutateCSharp.Schemata430.ReplaceStringConstant_7(101L, "bound variable"));
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_12(102L, () => context.IsExtremePredicate, () => context.IsExtremeLemma))
                    {
            ...
            else if (expr is MemberSelectExpr)
            {
                ...
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_12(108L, () => e.Member is Function, () => e.Member is Method))
                {
                    var i = MutateCSharp.Schemata430.ReplaceNumericConstant_4(114L, 0);
                    foreach (var p in Util.Concat(e.PreTypeApplication_AtEnclosingClass, e.PreTypeApplication_JustMember))
                    {
                        var tp = MutateCSharp.Schemata430.ReplaceBinExprOp_5(118L, i, e.PreTypeApplication_AtEnclosingClass.Count
            ) ? e.Member.EnclosingClass.TypeArgs[i]
                            : ((ICallable)e.Member).TypeArgs[MutateCSharp.Schemata430.ReplaceBinExprOp_15(123L, i, e.PreTypeApplication_AtEnclosingClass.Count)];
                        if (!IsDetermined(p))
                        {
                        ...
                        MutateCSharp.Schemata430.ReplacePostfixUnaryExprOp_6(132L, ref i);
                    }
                }
            ...
            else if (expr is FunctionCallExpr)
            {
                ...
                var i = MutateCSharp.Schemata430.ReplaceNumericConstant_4(133L, 0);
                foreach (var p in Util.Concat(e.PreTypeApplication_AtEnclosingClass, e.PreTypeApplication_JustFunction))
                {
                    var tp = MutateCSharp.Schemata430.ReplaceBinExprOp_5(137L, i, e.PreTypeApplication_AtEnclosingClass.Count
          ) ? e.Function.EnclosingClass.TypeArgs[i]
                        : e.Function.TypeArgs[MutateCSharp.Schemata430.ReplaceBinExprOp_15(142L, i, e.PreTypeApplication_AtEnclosingClass.Count)];
                    if (!IsDetermined(p))
                    {
                        var hint = e.Name.StartsWith(RevealStmt.RevealLemmaPrefix) ? MutateCSharp.Schemata430.ReplaceStringConstant_7(151L, ". If you are making an opaque function, make sure that the function can be called.") : "";
                    ...
                    MutateCSharp.Schemata430.ReplacePostfixUnaryExprOp_6(152L, ref i);
                }
            ...
            else if (expr is LetExpr)
            {
                ...
                foreach (var lhsPattern in e.LHSs)
                {
                    ...
                    {
                        CheckVariable(bv, MutateCSharp.Schemata430.ReplaceStringConstant_7(153L, "bound variable"));
            ...
            else if (expr is IdentifierExpr)
            {
                ...
                CheckPreTypeIsDetermined(expr.tok, expr.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(154L, "variable"));

            }
            else if (CheckPreTypeIsDetermined(expr.tok, expr.PreType, MutateCSharp.Schemata430.ReplaceStringConstant_7(155L, "expression")))
            {
                if (expr is UnaryOpExpr uop)
                {
                    ...
                    if (MutateCSharp.Schemata430.ReplaceBinExprOp_17(157L, () => MutateCSharp.Schemata430.ReplaceBinExprOp_16(156L, uop.Op, UnaryOpExpr.Opcode.Not), () => PreTypeResolver.IsBitvectorName(familyDeclName)))
                    {
        ...
        public static bool IsDetermined(PreType pt)
        {
            ...
            {
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_18(163L, dp.PrintablePreType, null))
                {
            ...
            return MutateCSharp.Schemata430.ReplaceBooleanConstant_19(164L, false);
        }
        ...
        public bool CheckPreTypeIsDetermined(IToken tok, PreType pt, string whatIsBeingChecked, PreType origPreType = null)
        {
            ...
            if (pt is PreTypeProxy proxy)
            {
                ...
                return MutateCSharp.Schemata430.ReplaceBooleanConstant_19(165L, false);
            }
            var dp = (DPreType)pt;
            if (MutateCSharp.Schemata430.ReplaceBinExprOp_18(166L, dp.PrintablePreType, null))
            {
                // If the type is a synonym, focus on it, which will check that all its type arguments have been filled in
                dp = dp.PrintablePreType;
            }
        ...
        public void CheckTypeArgsContainNoOrdinal(IToken tok, PreType preType)
        {
            ...
            {
                dp.Arguments.ForEach(tt => CheckContainsNoOrdinal(tok, tt, MutateCSharp.Schemata430.ReplaceStringConstant_7(167L, "an ORDINAL type is not allowed to be used as a type argument")));
            }
        }
        ...
        public void CheckContainsNoOrdinal(IToken tok, PreType preType, string errMsg)
        {
            ...
            if (preType.Normalize() is DPreType dp)
            {
                if (MutateCSharp.Schemata430.ReplaceBinExprOp_11(168L, PreTypeResolver.AncestorName(dp), PreType.TypeNameORDINAL))
                {
