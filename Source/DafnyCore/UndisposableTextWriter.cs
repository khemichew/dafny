...
{
    internal class Schemata485
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT485");
...
namespace Microsoft.Dafny
{
    public class UndisposableTextWriter : TextWriter
    {
        ...
        {
            WriteLine(MutateCSharp.Schemata485.ReplaceStringConstant_0(1L, "Tried to Dispose the writer at: ") + new Exception().StackTrace);
        }

        public override ValueTask DisposeAsync()
        {
            WriteLine(MutateCSharp.Schemata485.ReplaceStringConstant_0(2L, "Tried to DisposeAsync the writer at: ") + new Exception().StackTrace);
        ...
        public override string NewLine { get => textWriterImplementation.NewLine;
