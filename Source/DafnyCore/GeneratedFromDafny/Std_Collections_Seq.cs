...
{
    internal class Schemata293
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT293");
        ...
        internal static bool ReplaceBinExprOp_2(long mutantId, int argument1, System.Numerics.BigInteger argument2)
        {
        ...
        internal static bool ReplaceBinExprOp_6(long mutantId, System.Numerics.BigInteger argument1, System.Numerics.BigInteger argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 1)) { return argument1 <= argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 1) { return argument1 != argument2; }
...
namespace Std.Collections.Seq
{
    ...
    public partial class __default
    {
        ...
        {
            __T[] a = new __T[MutateCSharp.Schemata293.ReplaceNumericConstant_0(1L, 0)];
            ...
            __T[] _nw3 = new __T[Dafny.Helpers.ToIntChecked(new BigInteger((xs).Count), MutateCSharp.Schemata293.ReplaceStringConstant_1(5L, "array size exceeds memory limit"))];
            for (var _i0_2 = MutateCSharp.Schemata293.ReplaceNumericConstant_0(6L, 0); MutateCSharp.Schemata293.ReplaceBinExprOp_2(10L, _i0_2, new BigInteger(_nw3.Length)); MutateCSharp.Schemata293.ReplacePostfixUnaryExprOp_3(12L, ref _i0_2))
            {
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(17L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(13L, 0)))
            {
        ...
        {
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(26L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(22L, 0)))
            {
                return Std.Wrappers.Option<BigInteger>.create_None();
            }
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(35L, (length).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(31L, 0)))
            {
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(44L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(40L, 0)))
            {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(53L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(49L, 0)))
            {
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_5(58L, (new BigInteger((xs).Count)), (BigInteger.One)))
            {
                return (xs).Select(BigInteger.Zero);
            }
            else
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_5(59L, (new BigInteger((xs).Count)), (BigInteger.One)))
            {
                return (xs).Select(BigInteger.Zero);
            }
            else
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(64L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(60L, 0)))
            {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(73L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(69L, 0)))
            {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(82L, (new BigInteger((seqs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(78L, 0)))
            {
                return Dafny.Sequence<__T>.Concat(_101___accumulator, Dafny.Sequence<__T>.FromElements());
            }
            else if (MutateCSharp.Schemata293.ReplaceBinExprOp_5(87L, (new BigInteger((seqs).Count)), (BigInteger.One)))
            {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(92L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(88L, 0)))
            {
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(101L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(97L, 0)))
            {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(110L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(106L, 0)))
            {
        ...
        {
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(119L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(115L, 0)))
            {
                return init;
            }
            else
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(128L, (new BigInteger((xs).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(124L, 0)))
            {
                return init;
            }
            else
        ...
        public static Dafny.ISequence<__T> SetToSeq<__T>(Dafny.ISet<__T> s)
        {
            ...
            while (!(_113_left).Equals(Dafny.Set<__T>.FromElements()))
            {
                ...
                throw new System.Exception(MutateCSharp.Schemata293.ReplaceStringConstant_1(133L, "assign-such-that search produced no value (line 7245)"));
        ...
        {
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_6(134L, (new BigInteger((a).Count)), (BigInteger.One)))
            {
                return a;
            }
            else
            {
                BigInteger _115_splitIndex = Dafny.Helpers.EuclideanDivision(new BigInteger((a).Count), new BigInteger(MutateCSharp.Schemata293.ReplaceNumericConstant_0(136L, 2)));
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(144L, (new BigInteger((left).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(140L, 0)))
            {
                return Dafny.Sequence<__T>.Concat(_120___accumulator, right);
            }
            else if (MutateCSharp.Schemata293.ReplaceBinExprOp_4(153L, (new BigInteger((right).Count)).Sign, MutateCSharp.Schemata293.ReplaceNumericConstant_0(149L, 0)))
            {
