...
{
    internal class Schemata283
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT283");
...
namespace Std.Arithmetic.DivMod
{
    ...
    public partial class __default
    {
        ...
        {
            return MutateCSharp.Schemata283.ReplaceBinExprOp_0(1L, (Dafny.Helpers.EuclideanModulus(((m) * (a)) + (b), m)), (Dafny.Helpers.EuclideanModulus(b, m)));
        }
    }
