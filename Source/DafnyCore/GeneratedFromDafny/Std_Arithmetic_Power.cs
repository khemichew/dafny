...
{
    internal class Schemata291
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT291");
...
namespace Std.Arithmetic.Power
{
    ...
    public partial class __default
    {
        ...
        TAIL_CALL_START:;
            if (MutateCSharp.Schemata291.ReplaceBinExprOp_1(5L, (e).Sign, MutateCSharp.Schemata291.ReplaceNumericConstant_0(1L, 0)))
            {
