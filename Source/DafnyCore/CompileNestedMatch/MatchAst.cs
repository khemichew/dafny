...
{
    internal class Schemata249
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT249");
...
{
    public class MatchExpr : Expression, IMatch, ICloneable<MatchExpr>
    ...
    */
    ...
    public class HoleCtx : MatchingContext
    {
        ...
        public override string ToString()
        {
            return MutateCSharp.Schemata249.ReplaceStringConstant_0(1L, "*");
        }
    ...
    public class ForallCtx : MatchingContext
    {
        ...
        public override string ToString()
        {
            return MutateCSharp.Schemata249.ReplaceStringConstant_0(2L, "_");
        }
    }
    ...
    public class IdCtx : MatchingContext
    {
        ...
        public override string ToString()
        {
            if (MutateCSharp.Schemata249.ReplaceBinExprOp_2(7L, Arguments.Count, MutateCSharp.Schemata249.ReplaceNumericConstant_1(3L, 0)))
            {
                return Id;
            }
            else
            {
                ...
                return string.Format(MutateCSharp.Schemata249.ReplaceStringConstant_0(12L, "{0}({1})"), Id, string.Join(MutateCSharp.Schemata249.ReplaceStringConstant_0(13L, ", "), cps));
            }
        ...
        private bool ReplaceLeftmost(MatchingContext curr, out MatchingContext newContext)
        {
            ...
            bool foundHole = MutateCSharp.Schemata249.ReplaceBooleanConstant_3(14L, false);
            int currArgIndex = MutateCSharp.Schemata249.ReplaceNumericConstant_1(15L, 0);

            while (MutateCSharp.Schemata249.ReplaceBinExprOp_5(24L, () => !foundHole, () => MutateCSharp.Schemata249.ReplaceBinExprOp_4(19L, currArgIndex, this.Arguments.Count)))
            {
                ...
                MutateCSharp.Schemata249.ReplacePostfixUnaryExprOp_6(30L, ref currArgIndex);
            }

            if (foundHole)
            {
                while (MutateCSharp.Schemata249.ReplaceBinExprOp_4(31L, currArgIndex, this.Arguments.Count))
                {
                    newArguments.Add(this.Arguments.ElementAt(currArgIndex));
                    MutateCSharp.Schemata249.ReplacePostfixUnaryExprOp_6(36L, ref currArgIndex);
                }
            }
