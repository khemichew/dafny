...
{
    internal class Schemata250
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT250");
        ...
        internal static bool ReplaceBinExprOp_12(long mutantId, System.Collections.Generic.List<Microsoft.Dafny.ExtendedPattern> argument1, object argument2)
        {
        ...
        internal static bool ReplaceBinExprOp_10(long mutantId, System.Collections.Generic.Dictionary<string, Microsoft.Dafny.DatatypeCtor> argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_17(long mutantId, System.Collections.Generic.List<Microsoft.Dafny.ExtendedPattern> argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 != argument2; }
            return argument1 == argument2;
        ...
        internal static bool ReplaceBinExprOp_16(long mutantId, Microsoft.Dafny.LiteralExpr argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_0(long mutantId, Microsoft.Dafny.INode argument1, Microsoft.Dafny.Node argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
...
namespace Microsoft.Dafny
{
    ...
    public class MatchFlattener : IRewriter
    {
        ...
        private void FlattenNode(Node root)
        {
            root.Visit(node =>
            {
                if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(2L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_0(1L, node, root), () => node is ModuleDefinition))
                {
                    // The default module contains all the other modules, prevent visiting them since they're already visited as roots. 
                    return MutateCSharp.Schemata250.ReplaceBooleanConstant_2(8L, false);
                }

                if (node is ICallable callable)
                {
                    resolutionContext = new ResolutionContext(callable, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(9L, false));
                }
                ...
                if (node is NestedMatchStmt nestedMatchStmt)
                {
                    ...
                    return MutateCSharp.Schemata250.ReplaceBooleanConstant_2(10L, false);
                }
                ...
                if (node is NestedMatchExpr nestedMatchExpr)
                {
                    ...
                    return MutateCSharp.Schemata250.ReplaceBooleanConstant_2(11L, false);
                }

                return MutateCSharp.Schemata250.ReplaceBooleanConstant_2(12L, true);
            });
        }
        ...
        private Expression CompileNestedMatchExpr(NestedMatchExpr nestedMatchExpr)
        {
            ...
            {
                if (MutateCSharp.Schemata250.ReplaceBinExprOp_3(13L, nestedMatchExpr.Source.Type.AsDatatype, null))
                {
            ...
            {
                for (int id = MutateCSharp.Schemata250.ReplaceNumericConstant_4(14L, 0); MutateCSharp.Schemata250.ReplaceBinExprOp_5(18L, id, state.CaseCopyCount.Length); MutateCSharp.Schemata250.ReplacePostfixUnaryExprOp_6(23L, ref id))
                {
                    if (MutateCSharp.Schemata250.ReplaceBinExprOp_7(28L, state.CaseCopyCount[id], MutateCSharp.Schemata250.ReplaceNumericConstant_4(24L, 0)))
                    {
                        Reporter.Warning(MessageSource.Resolver, ErrorRegistry.NoneId, state.CaseTok[id], MutateCSharp.Schemata250.ReplaceStringConstant_8(33L, "this branch is redundant"));
                    }
                }
                return expression;
            }
        ...
        private Statement CompileNestedMatchStmt(NestedMatchStmt nestedMatchStmt)
        {
            var cases = nestedMatchStmt.Cases.SelectMany(FlattenNestedMatchCaseStmt)
              .Select(nms => nms.Clone(new Cloner(MutateCSharp.Schemata250.ReplaceBooleanConstant_2(34L, false), MutateCSharp.Schemata250.ReplaceBooleanConstant_2(35L, true))))
              .ToList();
            ...
            if (compiledMatch is null)
            {
                ...
                if (MutateCSharp.Schemata250.ReplaceBinExprOp_3(36L, nestedMatchStmt.Source.Type.AsDatatype, null))
                {
            ...
            if (compiledMatch.Node is Statement statement)
            {
                ...
                for (int id = MutateCSharp.Schemata250.ReplaceNumericConstant_4(37L, 0); MutateCSharp.Schemata250.ReplaceBinExprOp_5(41L, id, state.CaseCopyCount.Length); MutateCSharp.Schemata250.ReplacePostfixUnaryExprOp_6(46L, ref id))
                {
                    if (MutateCSharp.Schemata250.ReplaceBinExprOp_7(51L, state.CaseCopyCount[id], MutateCSharp.Schemata250.ReplaceNumericConstant_4(47L, 0)))
                    {
                        Reporter.Warning(MessageSource.Resolver, ErrorRegistry.NoneId, state.CaseTok[id], MutateCSharp.Schemata250.ReplaceStringConstant_8(56L, "this branch is redundant"));
                    }
                }

                new GhostInterestVisitor(resolutionContext.WithGhost(nestedMatchStmt.IsGhost).CodeContext, null, Reporter, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(57L, false), MutateCSharp.Schemata250.ReplaceBooleanConstant_2(58L, false)).
        ...
        private IEnumerable<ExtendedPattern> FlattenDisjunctivePatterns(ExtendedPattern pat)
        {
            ...
            return pat is DisjunctivePattern p
              ? p.Alternatives.Select(a => RemoveIllegalSubpatterns(a, inDisjunctivePattern: MutateCSharp.Schemata250.ReplaceBooleanConstant_2(59L, true)))
              : Enumerable.Repeat(RemoveIllegalSubpatterns(pat, inDisjunctivePattern: MutateCSharp.Schemata250.ReplaceBooleanConstant_2(60L, false)), MutateCSharp.Schemata250.ReplaceNumericConstant_4(61L, 1));
        }
        ...
        private CaseBody CompilePatternPaths(MatchCompilationState state, MatchingContext context, SinglyLinkedList<Expression> matchees, List<PatternPath> paths)
        {
            ...
            if (!paths.TrueForAll(x => MutateCSharp.Schemata250.ReplaceBinExprOp_9(65L, matchees.Count(), x.Patterns.Count)))
            {
                Reporter.Error(MessageSource.Resolver, state.Tok, MutateCSharp.Schemata250.ReplaceStringConstant_8(70L, "Match is malformed, make sure constructors are fully applied"));
            }

            if (MutateCSharp.Schemata250.ReplaceBinExprOp_9(75L, paths.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(71L, 0)))
            {
            ...
            for (int i = MutateCSharp.Schemata250.ReplaceNumericConstant_4(80L, 1); MutateCSharp.Schemata250.ReplaceBinExprOp_5(84L, i, paths.Count); MutateCSharp.Schemata250.ReplacePostfixUnaryExprOp_6(89L, ref i))
            {
                state.UpdateCaseCopyCount(paths[i].CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(90L, -1));
            }
          ...
          List<PatternPath> paths, Cons<Expression> consMatchees)
        {
            ...
            if (MutateCSharp.Schemata250.ReplaceBinExprOp_3(94L, dtd, null))
            {
                ctors = null;
            }
            else
            ...
            if (MutateCSharp.Schemata250.ReplaceBinExprOp_10(95L, ctors, null) && patternHeads.Exists(x =>
            ...
            else if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(103L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_3(96L, dtd, null), () => patternHeads.Exists(x => (MutateCSharp.Schemata250.ReplaceBinExprOp_11(97L, () => x is LitPattern, () => x is IdPattern { ResolvedLit: { } })))))
            {
            ...
            else
            {
                ...
                var tailPaths = paths.Select(path =>
                {
                    ...
                    if (MutateCSharp.Schemata250.ReplaceBinExprOp_12(109L, currPattern.Arguments, null))
                    {
                        if (MutateCSharp.Schemata250.ReplaceBinExprOp_3(110L, dtd, null))
                        {
                            Contract.Assert(false);
                ...
                MutateCSharp.Schemata250.ReplaceStringConstant_8(111L, "Type mismatch: expected constructor of type {0}.  Got {1}."), dtd.Name, currPattern.Id);
                        }
                    }
          ...
          List<PatternPath> paths)
        {
            ...
            {
                mti.UpdateCaseCopyCount(path.CaseId, MutateCSharp.Schemata250.ReplaceBinExprOp_13(116L, constructorByName.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(112L, 1)));
            }
            ...
            foreach (var ctor in constructorByName.Values)
            {
                ...
                var ctorCounter = MutateCSharp.Schemata250.ReplaceNumericConstant_4(125L, 0);
                ...
                foreach (var path in paths)
                {
                    ...
                    {
                        if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(131L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_14(129L, ctor.Name, idPattern.Id), () => MutateCSharp.Schemata250.ReplaceBinExprOp_12(130L, idPattern.Arguments, null)))
                        {
                            ...
                            if (MutateCSharp.Schemata250.ReplaceBinExprOp_15(137L, idPattern.Arguments.Count, ctor.Formals.Count))
                            {
                                Reporter.Error(MessageSource.Resolver, mti.CaseTok[tail.CaseId], MutateCSharp.Schemata250.ReplaceStringConstant_8(142L, "constructor {0} of arity {1} is applied to {2} argument(s)"), ctor.Name, ctor.Formals.Count, idPattern.Arguments.Count);
                            }
                            for (int j = MutateCSharp.Schemata250.ReplaceNumericConstant_4(143L, 0); MutateCSharp.Schemata250.ReplaceBinExprOp_5(147L, j, idPattern.Arguments.Count); MutateCSharp.Schemata250.ReplacePostfixUnaryExprOp_6(152L, ref j))
                            {
                                // mark patterns standing in for ghost field
                                idPattern.Arguments[j].IsGhost = MutateCSharp.Schemata250.ReplaceBinExprOp_11(153L, () => idPattern.Arguments[j].IsGhost, () => ctor.Formals[j].IsGhost);
                            }
                            tail.Patterns.InsertRange(MutateCSharp.Schemata250.ReplaceNumericConstant_4(159L, 0), idPattern.Arguments);
                            constructorPaths.Add(tail);
                            MutateCSharp.Schemata250.ReplacePostfixUnaryExprOp_6(163L, ref ctorCounter);
                        }
                        else if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(165L, () => constructorByName.ContainsKey(idPattern.Id), () => MutateCSharp.Schemata250.ReplaceBinExprOp_12(164L, idPattern.Arguments, null)))
                        {
                            // ==[3.2]== If the pattern is a different constructor, drop the path
                            mti.UpdateCaseCopyCount(tail.CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(171L, -1));
                        }
                        else if (MutateCSharp.Schemata250.ReplaceBinExprOp_16(175L, idPattern.ResolvedLit, null))
                        {
                            // TODO
                        }
                        else
                        {
                            ...
                            if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(186L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_12(176L, idPattern.Arguments, null), () => MutateCSharp.Schemata250.ReplaceBinExprOp_15(181L, idPattern.Arguments.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(177L, 0))))
                            {
                                Reporter.Error(MessageSource.Resolver, mti.CaseTok[tail.CaseId], MutateCSharp.Schemata250.ReplaceStringConstant_8(192L, "bound variable {0} applied to {1} argument(s)."), idPattern.Id, idPattern.Arguments.Count);
                            }
                            ...
                            tail.Patterns.InsertRange(MutateCSharp.Schemata250.ReplaceNumericConstant_4(193L, 0), freshArgs);
            ...
            if (mti.Match is NestedMatchStmt nestedMatchStmt)
            {
                ...
                {
                    if (Attributes.Contains(c.Attributes, MutateCSharp.Schemata250.ReplaceStringConstant_8(197L, "split")))
                    {
                        continue;
                    }

                    var args = new List<Expression>();
                    var literalExpr = Expression.CreateBoolLiteral(mti.Tok, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(198L, false));
                    args.Add(literalExpr);
                    c.Attributes = new Attributes(MutateCSharp.Schemata250.ReplaceStringConstant_8(199L, "split"), args, c.Attributes);
                }
                var newMatchStmt = new MatchStmt(nestedMatchStmt.RangeToken, headMatchee, newMatchCaseStmts, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(200L, true), mti.Attributes, context);
                newMatchStmt.IsGhost |= mti.CodeContext.IsGhost;
                return new CaseBody(null, newMatchStmt);
            }

            var newMatchExpr = new MatchExpr(mti.Tok, headMatchee, newMatchCases.ConvertAll(x => (MatchCaseExpr)x), MutateCSharp.Schemata250.ReplaceBooleanConstant_2(201L, true), context);
        ...
        private MatchCase CreateMatchCase(IToken tok, DatatypeCtor ctor, List<BoundVar> freshPatBV, CaseBody bodyContainer, bool fromBoundVar)
        {
            ...
            var cloner = new Cloner(MutateCSharp.Schemata250.ReplaceBooleanConstant_2(202L, false), MutateCSharp.Schemata250.ReplaceBooleanConstant_2(203L, true));
            if (bodyContainer.Node is Statement statement)
            {
                var body = UnboxStmt(statement).Select(stmt => cloner.CloneStmt(stmt, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(204L, false))).ToList();
        ...
        {
            var name = FreshTempVarName(MutateCSharp.Schemata250.ReplaceStringConstant_8(205L, "_mcc#"), codeContext);
        ...
        {
            var name = FreshTempVarName(MutateCSharp.Schemata250.ReplaceStringConstant_8(206L, "_mcc#"), codeContext);
        ...
        private CaseBody CompileHeadsContainingLiteralPattern(MatchCompilationState mti, MatchingContext context, Cons<Expression> matchees, List<PatternPath> paths)
        {
            ...
            foreach (var path in paths)
            {
                mti.UpdateCaseCopyCount(path.CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(207L, -1));
            }
            ...
            foreach (var path in paths)
            {
                ...
                if (MutateCSharp.Schemata250.ReplaceBinExprOp_16(211L, lit, null))
                {
                    lit.Type = matchees.Head.Type;
                }

                if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(213L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_16(212L, lit, null), () => !ifBlockLiterals.Exists(x => object.Equals(x.Value, lit.Value))))
                {
            ...
            foreach (var ifBlockLiteral in ifBlockLiterals)
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    if (MutateCSharp.Schemata250.ReplaceBinExprOp_16(219L, lit, null))
                    {
                        ...
                        {
                            mti.UpdateCaseCopyCount(tail.CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(220L, 1));
                    ...
                    else if (head is IdPattern _)
                    {
                        ...
                        mti.UpdateCaseCopyCount(tail.CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(224L, 1));
                        pathsForLiteral.Add(newPath);
                    }
                    else
                    {
            ...
            {
                var (head, tail) = SplitPath(path);
                if (head is IdPattern idPattern && idPattern.ResolvedLit == null && MutateCSharp.Schemata250.ReplaceBinExprOp_17(228L, idPattern.Arguments, null))
                {
                    var newPath = LetBindNonWildCard(idPattern, matchees.Head, tail);
                    mti.UpdateCaseCopyCount(tail.CaseId, MutateCSharp.Schemata250.ReplaceNumericConstant_4(229L, 1));
                    defaultPaths.Add(newPath);
                }
            }
            // defaultPaths.Count check is to avoid adding "missing paths" when default is not present
            var defaultBlock = MutateCSharp.Schemata250.ReplaceBinExprOp_9(237L, defaultPaths.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(233L, 0)) ? null : CompilePatternPaths(mti, context.AbstractHole(), matchees.Tail, defaultPaths);
        ...
        private static LiteralExpr GetLiteralExpressionFromPattern(ExtendedPattern head)
        {
            ...
            else if (head is IdPattern id && MutateCSharp.Schemata250.ReplaceBinExprOp_16(242L, id.ResolvedLit, null))
            {
                lit = id.ResolvedLit;
            }
          ...
          List<(LiteralExpr, CaseBody)> blocks, CaseBody defaultBlock)
        {
            ...
            if (MutateCSharp.Schemata250.ReplaceBinExprOp_9(247L, blocks.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(243L, 0)))
            {
            ...
            blocks = blocks.Skip(MutateCSharp.Schemata250.ReplaceNumericConstant_4(252L, 1)).ToList();
            ...
            var errorMessage = MutateCSharp.Schemata250.ReplaceBinExprOp_3(256L, mti.Match.Source.Type.AsDatatype, null
            ...
            if (currBlock.Item2.Node is Expression expression)
            {
                ...
                else
                {
                    ...
                    var result = new ITEExpr(tok, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(257L, false), guard, expression, els);
                    result.Type = ((NestedMatchExpr)mti.Match).Type;
                    return new CaseBody(null, result);
                }
            }
            ...
            if (currBlock.Item2.Node is Statement statement)
            {
                ...
                else
                {
                    ...
                    return new CaseBody(null, new IfStmt(range, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(258L, false), guard, item2, els));
                }
            }
        ...
        public class MatchCompilationState
        {
              ...
              Attributes attrs = null)
            {
                ...
                Array.Fill(CaseCopyCount, MutateCSharp.Schemata250.ReplaceNumericConstant_4(259L, 1));
        ...
        public abstract record PatternPath(IToken Tok, int CaseId, List<ExtendedPattern> Patterns)
        {
        }

        public record StmtPatternPath(IToken Tok, int CaseId, List<ExtendedPattern> Patterns,
            IReadOnlyList<Statement> Body, Attributes Attributes) : PatternPath(Tok, CaseId, Patterns)
        {
            ...
            public override string ToString()
            {
                ...
                {
                    bodyStr += string.Format(MutateCSharp.Schemata250.ReplaceStringConstant_8(263L, "{1}{0};\n"), Printer.StatementToString(DafnyOptions.DefaultImmutableOptions, stmt), MutateCSharp.Schemata250.ReplaceStringConstant_8(264L, "\t"));
                }
                return string.Format(MutateCSharp.Schemata250.ReplaceStringConstant_8(265L, "\t> id: {0}\n\t> patterns: <{1}>\n\t-> body:\n{2} \n"), this.CaseId, String.Join(MutateCSharp.Schemata250.ReplaceStringConstant_8(266L, ","), this.Patterns.ConvertAll(x => x.ToString())), bodyStr);
            }
        }

        public record ExprPatternPath(IToken Tok, int CaseId, List<ExtendedPattern> Patterns,
            Expression Body, Attributes Attributes) : PatternPath(Tok, CaseId, Patterns)
        {
            ...
            {
                return
                  $"\t> id: {this.CaseId}\n\t-> patterns: <{String.Join(MutateCSharp.Schemata250.ReplaceStringConstant_8(267L, ","), this.Patterns.ConvertAll(x => x.ToString()))}>\n\t-> body: {Printer.ExprToString(DafnyOptions.DefaultImmutableOptions, this.Body)}";
            }
        }
        ...
        private static PatternPath DropPatternHead(PatternPath path)
        {
            return path switch
            {
                ExprPatternPath expr => new ExprPatternPath(expr.Tok, expr.CaseId, expr.Patterns.Skip(MutateCSharp.Schemata250.ReplaceNumericConstant_4(268L, 1)).ToList(), expr.Body,
                  expr.Attributes),
                StmtPatternPath stmt => new StmtPatternPath(stmt.Tok, stmt.CaseId, stmt.Patterns.Skip(MutateCSharp.Schemata250.ReplaceNumericConstant_4(272L, 1)).ToList(), stmt.Body,
                  stmt.Attributes),
        ...
        private PatternPath LetBind(IdPattern var, Expression genExpr, PatternPath bodyPath)
        {
            ...
            {
                if (MutateCSharp.Schemata250.ReplaceBinExprOp_1(285L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_7(280L, stmtPath.Body.Count, MutateCSharp.Schemata250.ReplaceNumericConstant_4(276L, 0)), () => var.Type is TypeProxy))
                {
                    return stmtPath;
                }
                ...
                var caseLet = new VarDeclPattern(caseLocal.RangeToken, casePattern, expr, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(291L, false))
                {
                    IsGhost = isGhost
                };
        ...
        { var.BoundVar, caseLocal }
                ...
                var cloner = new SubstitutingCloner(substitutions, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(292L, true));
                var clonedBody = stmtPath.Body.Select(s => cloner.CloneStmt(s, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(293L, false))).ToList();
            ...
            if (bodyPath is ExprPatternPath exprPath)
            {
                ...
                var letExpr = new LetExpr(cBVar.tok, cPats, exprs, exprPath.Body, MutateCSharp.Schemata250.ReplaceBooleanConstant_2(294L, true));
        ...
        private PatternPath LetBindNonWildCard(IdPattern idPattern, Expression expr, PatternPath bodyPath)
        {
            ...
            if (MutateCSharp.Schemata250.ReplaceBinExprOp_11(308L, () => MutateCSharp.Schemata250.ReplaceBinExprOp_16(295L, idPattern.ResolvedLit, null), () => (MutateCSharp.Schemata250.ReplaceBinExprOp_1(302L, () => idPattern.IsWildcardPattern, () => (MutateCSharp.Schemata250.ReplaceBinExprOp_11(296L, () => idPattern.Id.Contains('#'), () => idPattern.Type is TypeProxy))))))
            {
                return bodyPath;
            }
