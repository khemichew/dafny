...
namespace MutateCSharp
{
    internal class Schemata2
    {
        ...
        internal static bool ReplaceBinExprOp_5(long mutantId, Microsoft.Dafny.PrefixLemma argument1, object argument2)
        {
        ...
        internal static bool ReplaceBinExprOp_7(long mutantId, System.Collections.Generic.List<Microsoft.Dafny.BoundVar> argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_3(long mutantId, Microsoft.Dafny.PrefixPredicate argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
...
namespace Microsoft.Dafny
{
    ...
    {
        ModuleDefinition EnclosingModule { get; }
    }
    ...
    public abstract class ASTVisitor<VisitorContext> where VisitorContext : IASTVisitorContext
    {
        ...
        protected virtual void VisitOneDeclaration(TopLevelDecl decl)
        {
            ...
            {
                var context = GetContext(dd, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(1L, false));
                var baseType = (decl as NewtypeDecl)?.BaseType ?? ((TypeSynonymDeclBase)decl).Rhs;
                VisitUserProvidedType(baseType, context);
                if (MutateCSharp.Schemata2.ReplaceBinExprOp_1(2L, dd.Constraint, null))
                {
                    VisitExpression(dd.Constraint, context);
                }
                if (MutateCSharp.Schemata2.ReplaceBinExprOp_1(3L, dd.Witness, null))
                {
            ...
            else if (decl is DatatypeDecl datatypeDecl)
            {
                ...
                foreach (var ctor in datatypeDecl.Ctors)
                {
                    var context = GetContext(datatypeDecl, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(4L, false));
        ...
        {
            var context = GetContext(iteratorDecl, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(5L, false));
            ...
            if (MutateCSharp.Schemata2.ReplaceBinExprOp_2(6L, iteratorDecl.Body, null))
            {
        ...
        public void VisitMember(MemberDecl member)
        {
            ...
            else if (member is Function function)
            {
                ...
                if (MutateCSharp.Schemata2.ReplaceBinExprOp_3(7L, prefixPredicate, null))
                {
                    VisitFunction(prefixPredicate);
                }

                if (MutateCSharp.Schemata2.ReplaceBinExprOp_4(8L, function.ByMethodDecl, null))
                {
            ...
            else if (member is Method method)
            {
                ...
                if (MutateCSharp.Schemata2.ReplaceBinExprOp_5(9L, prefixLemma, null))
                {
        ...
        public virtual void VisitField(Field field)
        {
            ...
            var context = GetContext(field as IASTVisitorContext ?? new NoContext(enclosingModule), MutateCSharp.Schemata2.ReplaceBooleanConstant_0(10L, false));
        ...
        {
            var context = GetContext(function, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(11L, false));
            ...
            function.Ens.ForEach(aexpr => VisitAttributedExpression(aexpr, GetContext(function, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(12L, true))));
            ...
            if (MutateCSharp.Schemata2.ReplaceBinExprOp_1(13L, function.Body, null))
            {
        ...
        {
            var context = GetContext(method, MutateCSharp.Schemata2.ReplaceBooleanConstant_0(14L, false));
            ...
            if (MutateCSharp.Schemata2.ReplaceBinExprOp_2(15L, method.Body, null))
            {
        ...
        {
            formals
              .Where(formal => MutateCSharp.Schemata2.ReplaceBinExprOp_1(16L, formal.DefaultValue, null))
        ...
        private void VisitAttributes(IAttributeBearingDeclaration parent, ModuleDefinition enclosingModule)
        {
            foreach (var attribute in parent.Attributes.AsEnumerable())
            {
                ...
                {
                    VisitExpression(arg, GetContext(new NoContext(enclosingModule), MutateCSharp.Schemata2.ReplaceBooleanConstant_0(17L, false)));
                }
            }
        }
        ...
        protected virtual void VisitExpression(Expression expr, VisitorContext context)
        {
            if (VisitOneExpression(expr, context))
            {
                ...
                if (expr is SeqConstructionExpr seqConstructionExpr)
                {
                    ...
                    if (MutateCSharp.Schemata2.ReplaceBinExprOp_6(18L, userProvidedElementType, null))
                    {
        ...
        {
            return MutateCSharp.Schemata2.ReplaceBooleanConstant_0(19L, true);
        }
        ...
        protected virtual void VisitStatement(Statement stmt, VisitorContext context)
        {
            if (VisitOneStatement(stmt, context))
            {
                ...
                else if (stmt is AssignStmt assignStmt)
                {
                    ...
                    {
                        if (MutateCSharp.Schemata2.ReplaceBinExprOp_6(20L, typeRhs.EType, null))
                        {
                ...
                else if (stmt is MatchStmt matchStmt)
                {
                    ...
                    {
                        if (MutateCSharp.Schemata2.ReplaceBinExprOp_7(21L, mc.Arguments, null))
                        {
                            foreach (BoundVar v in mc.Arguments)
                            {
                                VisitUserProvidedType(v.Type, context);
        ...
        {
            return MutateCSharp.Schemata2.ReplaceBooleanConstant_0(22L, true);
        }
