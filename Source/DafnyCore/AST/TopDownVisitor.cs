...
{
    internal class Schemata182
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT182");
...
namespace Microsoft.Dafny
{
    public class TopDownVisitor<State>
    {
        ...
        protected bool preResolve = MutateCSharp.Schemata182.ReplaceBooleanConstant_0(1L, false);
        ...
        {
            if (MutateCSharp.Schemata182.ReplaceBinExprOp_1(2L, () => !allowAutoGenerated, () => AutoGeneratedToken.Is(expr.tok)))
            {
                return;
            }
        ...
        public virtual void Visit(Method method, State st)
        {
            ...
            if (MutateCSharp.Schemata182.ReplaceBinExprOp_2(8L, method.Body, null)) { Visit(method.Body, st); }
            //TODO More?
        }
        public virtual void Visit(Function function, State st)
        {
            ...
            if (MutateCSharp.Schemata182.ReplaceBinExprOp_3(9L, function.Body, null)) { Visit(function.Body, st); }
            //TODO More?
        }
        /// <summary>
        ...
        {
            Contract.Requires(expr != null);
            return MutateCSharp.Schemata182.ReplaceBooleanConstant_0(10L, true);  // by default, visit the sub-parts with the same "st"
        }
        ...
        {
            Contract.Requires(stmt != null);
            return MutateCSharp.Schemata182.ReplaceBooleanConstant_0(11L, true);  // by default, visit the sub-parts with the same "st"
        }
    }
}