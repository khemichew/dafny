...
{
    internal class Schemata132
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT132");
...
namespace Microsoft.Dafny
{
    public class Program : TokenNode
    {
        ...
        {
            return GetFirstTokenForUri(Compilation.RootSourceUris[MutateCSharp.Schemata132.ReplaceNumericConstant_0(1L, 0)]);
        }
