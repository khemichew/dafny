...
{
    internal class Schemata154
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT154");
...
namespace Microsoft.Dafny
{
    public class GuardedAlternative : TokenNode, IAttributeBearingDeclaration
    {
        ...
        public override IEnumerable<INode> Children => (MutateCSharp.Schemata154.ReplaceBinExprOp_0(1L, Attributes, null) ? new List<Node> { Attributes } : Enumerable.Empty<Node>()).Concat(new List<Node>() { Guard }).Concat<Node>(Body);
