...
{
    internal class Schemata46
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT46");
        ...
        internal static bool ReplaceBinExprOp_0(long mutantId, Microsoft.Dafny.LiteralExpr argument1, object argument2)
        {
...
namespace Microsoft.Dafny
{
    public class LitPattern : ExtendedPattern
    {
        ...
        public LiteralExpr OptimisticallyDesugaredLit
        {
            get
            {
                if (MutateCSharp.Schemata46.ReplaceBinExprOp_0(1L, optimisticallyDesugaredLit, null))
                {
                    if (OrigLit is NegationExpression neg)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Uri = neg.tok.Uri,
                                val = MutateCSharp.Schemata46.ReplaceStringConstant_1(2L, "-0"
                )
                            };
        ...
        MutateCSharp.Schemata46.ReplaceStringConstant_1(3L, "literal expression in case (of type '{1}') not assignable to match source type '{0}'"));
        }
    }
}
