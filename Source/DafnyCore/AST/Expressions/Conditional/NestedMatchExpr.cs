...
{
    internal class Schemata41
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT41");
...
interface INestedMatch : INode
    ...
    public class NestedMatchExpr : Expression, ICloneable<NestedMatchExpr>, ICanFormat, INestedMatch
    {
        ...
        public string MatchTypeName => MutateCSharp.Schemata41.ReplaceStringConstant_0(1L, "expression");
        ...
        public void Resolve(ModuleResolver resolver, ResolutionContext resolutionContext)
        {
            ...
            {
                resolver.PartiallySolveTypeConstraints(MutateCSharp.Schemata41.ReplaceBooleanConstant_1(2L, true));

                if (Source.Type is TypeProxy)
                {
                    resolver.reporter.Error(MessageSource.Resolver, tok, MutateCSharp.Schemata41.ReplaceStringConstant_0(3L, "Could not resolve the type of the source of the match expression. Please provide additional typing annotations."));
                    return;
                }
            }
            ...
            if (MutateCSharp.Schemata41.ReplaceBinExprOp_2(4L, resolver.reporter.Count(ErrorLevel.Error), errorCount))
            {
                return;
            }
            ...
            if (MutateCSharp.Schemata41.ReplaceBinExprOp_2(9L, resolver.reporter.Count(ErrorLevel.Error), errorCount))
            {
                return;
            }
