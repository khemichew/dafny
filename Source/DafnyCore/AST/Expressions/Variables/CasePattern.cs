...
{
    internal class Schemata72
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT72");
...
namespace Microsoft.Dafny
{
      ...
      where VT : class, IVariable
    {
        ...
        public CasePattern(Cloner cloner, CasePattern<VT> original)
        {
            ...
            {
                Var = cloner.CloneIVariable(original.Var, MutateCSharp.Schemata72.ReplaceBooleanConstant_0(1L, false));
            }
