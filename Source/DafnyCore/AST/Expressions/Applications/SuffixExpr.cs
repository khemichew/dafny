...
{
    internal class Schemata17
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT17");
...
namespace Microsoft.Dafny
{
    ...
    public abstract class SuffixExpr : ConcreteSyntaxExpression
    {
        ...
        public override IEnumerable<INode> Children => MutateCSharp.Schemata17.ReplaceBinExprOp_0(1L, ResolvedExpression, null) ? new[] { Lhs } : base.Children;
        ...
        public override IEnumerable<Expression> SubExpressions
        {
            get
            {
                ...
                else if (MutateCSharp.Schemata17.ReplaceBinExprOp_1(2L, Resolved, null))
                {
