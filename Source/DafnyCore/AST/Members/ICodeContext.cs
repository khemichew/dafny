...
{
    internal class Schemata105
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT105");
...
namespace Microsoft.Dafny
{
    ...
    public class NoContext : ICodeContext
    {
        ...
        {
            get { return MutateCSharp.Schemata105.ReplaceBooleanConstant_0(1L, true); }
        }
        ...
        bool ICodeContext.MustReverify
        {
            get
            {
                Contract.Assume(false, "should not be called on NoContext"); throw new cce.UnreachableException();
                return default;
            }
        }
        ...
        public bool AllowsAllocation => MutateCSharp.Schemata105.ReplaceBooleanConstant_0(2L, true);
    }
    ...
    public interface RedirectingTypeDecl : ICallable
    {
        ...
        bool ConstraintIsCompilable { get; set; }
    }
}