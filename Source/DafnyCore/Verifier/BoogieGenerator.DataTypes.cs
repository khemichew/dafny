...
{
    internal class Schemata488
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT488");
        ...
        internal static bool ReplaceBinExprOp_7(long mutantId, Microsoft.Boogie.Type argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_6(long mutantId, Microsoft.Boogie.Expr argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 != argument2; }
            return argument1 == argument2;
        ...
        internal static bool ReplaceBinExprOp_9(long mutantId, Microsoft.Boogie.Function argument1, Microsoft.Boogie.Function argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 == argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 != argument2; }
            return argument1 == argument2;
...
namespace Microsoft.Dafny
{
    public partial class BoogieGenerator
    {
        void AddDatatype(DatatypeDecl dt)
        {
            ...
            //         $Is(d, T(G)) ==> Dt.Ctor0?(G,d) || Dt.Ctor1?(G,d) || ...);
            {
                ...
                foreach (DatatypeCtor ctor in dt.Ctors)
                {
                    ...
                    tr = new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(1L, true), new List<Bpl.Expr> { disj, isPredicate }, tr);
                }
                var body = BplImp(isPredicate, cases_body);
                var ax = BplForall(boundVariables, tr, body);
                var axiom = new Bpl.Axiom(dt.tok, ax, MutateCSharp.Schemata488.ReplaceStringConstant_1(2L, "Questionmark data type disjunctivity"));
          ...
          IndDatatypeDecl dt)
        {
            ...
            args.Add(new Bpl.Formal(dt.tok, new Bpl.TypedIdent(dt.tok, Bpl.TypedIdent.NoName, predef.DatatypeType), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(3L, false)));
            args.Add(new Bpl.Formal(dt.tok, new Bpl.TypedIdent(dt.tok, Bpl.TypedIdent.NoName, predef.DatatypeType), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(4L, false)));
            var ctorEqualResult =
              new Bpl.Formal(dt.tok, new Bpl.TypedIdent(dt.tok, Bpl.TypedIdent.NoName, Bpl.Type.Bool), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(5L, false));
            sink.AddTopLevelDeclaration(new Bpl.Function(dt.tok, dtEqualName, args, ctorEqualResult,
      MutateCSharp.Schemata488.ReplaceStringConstant_1(6L, "Datatype extensional equality declaration")));

            var aVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(7L, "a"), predef.DatatypeType, out var a);
            var bVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(8L, "b"), predef.DatatypeType, out var b);
            ...
            foreach (var ctor in dt.Ctors)
            {
                Bpl.Trigger trigger;
                Bpl.Expr ante;
                if (MutateCSharp.Schemata488.ReplaceBinExprOp_3(13L, dt.Ctors.Count, MutateCSharp.Schemata488.ReplaceNumericConstant_2(9L, 1)))
                {
                    ante = Bpl.Expr.True;
                ...
                else
                {
                    ...
                    trigger = MutateCSharp.Schemata488.ReplaceBinExprOp_3(22L, dt.Ctors.Count, MutateCSharp.Schemata488.ReplaceNumericConstant_2(18L, 1
          )) ? BplTrigger(dtEqual)
                      : new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(27L, true), new List<Bpl.Expr> { dtEqual, ctorQa },
                        new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(28L, true), new List<Bpl.Expr> { dtEqual, ctorQb }));
                }

                Bpl.Expr eqs = Bpl.Expr.True;
                for (var i = MutateCSharp.Schemata488.ReplaceNumericConstant_2(29L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(33L, i, ctor.Formals.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(38L, ref i))
                {
        ...
        {
            return dt.FullSanitizedName + MutateCSharp.Schemata488.ReplaceStringConstant_1(39L, "#Equal");
        }
        ...
        private void AddExtensionalityAxiom(IndDatatypeDecl dt)
        {
            var dtEqualName = DtEqualName(dt);
            {
                var aVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(40L, "a"), predef.DatatypeType, out var a);
                var bVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(41L, "b"), predef.DatatypeType, out var b);
        ...
        private void AddCoDatatypeDeclAxioms(CoDatatypeDecl codecl)
        {
            ...
            {
                if (MutateCSharp.Schemata488.ReplaceBinExprOp_6(42L, k, null))
                {
                    return null;
                }
                else if (k.Type.IsInt)
                {
                    return Bpl.Expr.Sub(k, Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(43L, 1)));
                }
                else
                {
                    return FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(47L, "ORD#Minus"), k.Type, k,
                      FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(48L, "ORD#FromNat"), k.Type, Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(49L, 1))));
                }
            ...
            Action<Bpl.Type, Action<Tuple<List<Type>, List<Type>>, List<Bpl.Variable>, List<Bpl.Expr>, List<Bpl.Expr>,
              ...
              Map(codecl.TypeArgs, tp =>
                new TypeParameter(tp.RangeToken, tp.NameNode.Append(MutateCSharp.Schemata488.ReplaceStringConstant_1(53L, "#") + s), tp.PositionalIndex, tp.Parent));
                  List<TypeParameter> typaramsL = renew(MutateCSharp.Schemata488.ReplaceStringConstant_1(54L, "l")), typaramsR = renew(MutateCSharp.Schemata488.ReplaceStringConstant_1(55L, "r"));
                  ...
                  Bpl.Variable kVar;
                  if (MutateCSharp.Schemata488.ReplaceBinExprOp_7(56L, typeOfK, null))
                  {
                      kVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(57L, "k"), typeOfK, out k);
                      vars.Add(kVar);
                      if (typeOfK.IsInt)
                      {
                          kIsValid = Bpl.Expr.Le(Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(58L, 0)), k);
                          kIsNonZero = Bpl.Expr.Neq(Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(62L, 0)), k);
                          kHasSuccessor = Bpl.Expr.Lt(Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(66L, 0)), k);
                          kIsLimit = Bpl.Expr.False;
                      }
                      else
                      {
                          kIsValid = Bpl.Expr.True;
                          kIsNonZero = Bpl.Expr.Neq(k, FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(70L, "ORD#FromNat"), Bpl.Type.Int, Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(71L, 0))));
                          kHasSuccessor = Bpl.Expr.Lt(Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(75L, 0)), FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(79L, "ORD#Offset"), Bpl.Type.Int, k));
                          kIsLimit = FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(80L, "ORD#IsLimit"), Bpl.Type.Bool, k);
                      }
                  }
                  else
                  {
                  ...
                  var ly = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(81L, "ly"), predef.LayerType, vars);
                  var d0 = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(82L, "d0"), predef.DatatypeType, vars);
                  var d1 = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(83L, "d1"), predef.DatatypeType, vars);
            ...
            {
                {
                    ...
                    var args = MkTyParamFormals(Concat(GetTypeParams(codecl), GetTypeParams(codecl)), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(84L, false), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(85L, false));
                    if (MutateCSharp.Schemata488.ReplaceBinExprOp_7(86L, typeOfK, null))
                    {
                        args.Add(BplFormalVar(null, typeOfK, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(87L, true)));
                    }

                    args.Add(BplFormalVar(null, predef.LayerType, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(88L, true)));
                    args.Add(BplFormalVar(null, predef.DatatypeType, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(89L, true)));
                    args.Add(BplFormalVar(null, predef.DatatypeType, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(90L, true)));
                    var r = BplFormalVar(null, Bpl.Type.Bool, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(91L, false));
                    var fn_nm = MutateCSharp.Schemata488.ReplaceBinExprOp_7(92L, typeOfK, null) ? CoPrefixName(codecl) : CoEqualName(codecl);
  ...
  MutateCSharp.Schemata488.ReplaceBinExprOp_6(93L, k, null
  ) ? Bpl.Expr.True
                      ...
                      AddOtherDefinition(GetOrCreateTypeConstructor(codecl), new Bpl.Axiom(codecl.tok, ax, MutateCSharp.Schemata488.ReplaceStringConstant_1(94L, "Layered co-equality axiom")));
                  });
                ...
                CoAxHelper(typeOfK,
                  (tyargs, vars, lexprs, rexprs, kVar, k, kIsValid, kIsNonZero, kHasSuccessor, kIsLimit, ly, d0, d1) =>
                  {
                      ...
                      AddOtherDefinition(GetOrCreateTypeConstructor(codecl), new Bpl.Axiom(codecl.tok, ax, MutateCSharp.Schemata488.ReplaceStringConstant_1(95L, "Unbump layer co-equality axiom")));
                  });
            };
        ...
        MutateCSharp.Schemata488.ReplaceStringConstant_1(96L, "Equality for codatatypes")));
            });
        ...
        MutateCSharp.Schemata488.ReplaceStringConstant_1(97L, "Coequality and prefix equality connection")));
            });
            ...
            if (!theTypeOfK.IsInt)
            {
                CoAxHelper(Bpl.Type.Int,
                  ...
                  {
                      var Eq = CoEqualCall(codecl, lexprs, rexprs, null, LayerSucc(ly), d0, d1);
                      var PEq = CoEqualCall(codecl, lexprs, rexprs, FunctionCall(k.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(98L, "ORD#FromNat"), predef.BigOrdinalType, k),
                LayerSucc(ly), d0, d1);
                      vars.Remove(kVar);
                      AddOtherDefinition(GetOrCreateTypeConstructor(codecl), new Axiom(codecl.tok,
                BplForall(vars, BplTrigger(Eq), BplImp(BplForall(kVar, BplTrigger(PEq), BplImp(kIsValid, PEq)), Eq)),
  MutateCSharp.Schemata488.ReplaceStringConstant_1(99L, "Coequality and prefix equality connection")));
                  });
            }
            ...
            CoAxHelper(theTypeOfK,
              (tyargs, vars, lexprs, rexprs, kVar, k, kIsValid, kIsNonZero, kHasSuccessor, kIsLimit, ly, d0, d1) =>
              {
                  var m = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(100L, "m"), k.Type, vars);
                  ...
                  {
                      kLtM = FunctionCall(codecl.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(101L, "ORD#Less"), Bpl.Type.Bool, k, m);
                  }
                  AddOtherDefinition(GetOrCreateTypeConstructor(codecl), new Axiom(codecl.tok,
              BplForall(vars,
                new Bpl.Trigger(codecl.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(102L, true), new List<Bpl.Expr> { PEqK, PEqM }),
                BplImp(BplAnd(BplAnd(kIsValid, kLtM), PEqM), PEqK)),
  MutateCSharp.Schemata488.ReplaceStringConstant_1(103L, "Prefix equality consequence")));
              });
            ...
            CoAxHelper(theTypeOfK,
              (tyargs, vars, lexprs, rexprs, kVar, k, kIsValid, kIsNonZero, kHasSuccessor, kIsLimit, ly, d0, d1) =>
              {
                  ...
                  AddOtherDefinition(GetOrCreateTypeConstructor(codecl), new Axiom(codecl.tok,
              BplForall(vars, trigger, BplImp(BplAnd(equal, kIsValid), PEq)), MutateCSharp.Schemata488.ReplaceStringConstant_1(104L, "Prefix equality shortcut")));
              });
        }
        ...
        private void AddDepthOneCaseSplitFunction(DatatypeDecl dt)
        {
            ...
            //   }
            var cases_dBv = new Bpl.Formal(dt.tok, new Bpl.TypedIdent(dt.tok, Bpl.TypedIdent.NoName, predef.DatatypeType), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(105L, true));
            var cases_resType = new Bpl.Formal(dt.tok, new Bpl.TypedIdent(dt.tok, Bpl.TypedIdent.NoName, Bpl.Type.Bool), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(106L, false));
            var cases_fn = new Bpl.Function(dt.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(107L, "$IsA#") + dt.FullSanitizedName,
              new List<Variable> { cases_dBv },
              cases_resType,
      MutateCSharp.Schemata488.ReplaceStringConstant_1(108L, "Depth-one case-split function"));
            ...
            var dVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(109L, "d"), predef.DatatypeType, out var d);
            ...
            sink.AddTopLevelDeclaration(new Bpl.Axiom(dt.tok, ax, MutateCSharp.Schemata488.ReplaceStringConstant_1(110L, "Depth-one case-split axiom")));
        }
        ...
        MutateCSharp.Schemata488.ReplaceBooleanConstant_0(111L, true));
                argTypes.Add(a);
            }

            Bpl.Variable resType = new Bpl.Formal(ctor.tok,
              new Bpl.TypedIdent(ctor.tok, Bpl.TypedIdent.NoName, predef.DatatypeType), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(112L, false));
            Bpl.Function fn;
            if (dt is TupleTypeDecl ttd && ttd.Dims == 2 && MutateCSharp.Schemata488.ReplaceBinExprOp_3(117L, ttd.NonGhostDims, MutateCSharp.Schemata488.ReplaceNumericConstant_2(113L, 2)))
            {
                fn = predef.Tuple2Constructor;
            }
            else
            {
                fn = new Bpl.Function(ctor.tok, ctor.FullName, argTypes, resType, MutateCSharp.Schemata488.ReplaceStringConstant_1(122L, "Constructor function declaration"));
                sink.AddTopLevelDeclaration(fn);
            }
...

            {
                ...
                Bpl.Constant constructorId = new Bpl.Constant(ctor.tok,
                  new Bpl.TypedIdent(ctor.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(123L, "#") + ctor.FullName, predef.DtCtorId), MutateCSharp.Schemata488.ReplaceBooleanConstant_0(124L, true),
...

                {
                    ...
                    var thVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(125L, "d"), predef.DatatypeType, out var th);
                    ...
                    sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, ax, MutateCSharp.Schemata488.ReplaceStringConstant_1(126L, "Questionmark and identifier")));
                }
...

            {
                ...
                var dBv = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(127L, "d"), predef.DatatypeType, out var dId);
                Bpl.Expr q = Bpl.Expr.Eq(dId, rhs);
                if (MutateCSharp.Schemata488.ReplaceBinExprOp_8(132L, bvs.Count, MutateCSharp.Schemata488.ReplaceNumericConstant_2(128L, 0)))
                {
                ...
                sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(137L, "Constructor questionmark has arguments")));
            }
            ...
            if (dt is IndDatatypeDecl)
            {
                ...
                var constructorLiteralAxiom = new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(138L, "Constructor literal"));
                AddOtherDefinition(fn, constructorLiteralAxiom);
            }

            // Injectivity axioms for normal arguments
            for (int i = MutateCSharp.Schemata488.ReplaceNumericConstant_2(139L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(143L, i, ctor.Formals.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(148L, ref i))
            {
                var arg = ctor.Formals[i];
                ...
                if (MutateCSharp.Schemata488.ReplaceBinExprOp_10(151L, () => MutateCSharp.Schemata488.ReplaceBinExprOp_9(149L, fn, predef.Tuple2Destructors0), () => MutateCSharp.Schemata488.ReplaceBinExprOp_9(150L, fn, predef.Tuple2Destructors1)))
                {
                    // the two destructors for 2-tuples are predefined in Prelude for use
                    // by the Map#Items axiom
                }
                else if (MutateCSharp.Schemata488.ReplaceBinExprOp_11(161L, sf.EnclosingCtors[MutateCSharp.Schemata488.ReplaceNumericConstant_2(157L, 0)], ctor))
                {
                ...
                AddOtherDefinition(fn, (new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(162L, "Constructor injectivity"))));

                if (dt is IndDatatypeDecl)
                {
                    var argType = arg.Type.NormalizeExpand();
                    if (MutateCSharp.Schemata488.ReplaceBinExprOp_10(163L, () => argType.IsDatatype, () => argType.IsTypeParameter))
                    {
                        ...
                        AddOtherDefinition(fn, new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(169L, "Inductive rank")));
                    }
                    else if (argType is SeqType)
                    {
                        ...
                        {
                            CreateBoundVariables(ctor.Formals, out bvs, out args);
                            Bpl.Variable iVar = new Bpl.BoundVariable(arg.tok, new Bpl.TypedIdent(arg.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(170L, "i"), Bpl.Type.Int));
                            bvs.Add(iVar);
                            Bpl.IdentifierExpr ie = new Bpl.IdentifierExpr(arg.tok, iVar);
                            Bpl.Expr ante = BplAnd(
                              Bpl.Expr.Le(Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(171L, 0)), ie),
                            ...
                            var rhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ct);
                            q = new Bpl.ForallExpr(ctor.tok, bvs, new Trigger(lhs.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(175L, true), new List<Bpl.Expr> { seqIndex, ct }),
                              BplImp(ante, Bpl.Expr.Lt(lhs, rhs)));
                            sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(176L, "Inductive seq element rank")));
                        }
                        ...
                        // axiom (forall params {#dt.ctor(params)} :: SeqRank(arg) < DtRank(#dt.ctor(params)));
                        {
                            ...
                            var trigger = BplTrigger(ct);
                            q = new Bpl.ForallExpr(ctor.tok, bvs, trigger, Bpl.Expr.Lt(lhs, rhs));
                            AddOtherDefinition(fn, new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(177L, "Inductive seq rank")));
                        }
                    }
                    else if (argType is SetType)
                    {
                        ...
                        CreateBoundVariables(ctor.Formals, out bvs, out args);
                        Bpl.Variable dVar = new Bpl.BoundVariable(arg.tok, new Bpl.TypedIdent(arg.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(178L, "d"), predef.DatatypeType));
                        bvs.Add(dVar);
                        ...
                        var ct = FunctionCall(ctor.tok, ctor.FullName, predef.DatatypeType, args);
                        var rhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ct);
                        var trigger = new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(179L, true), new List<Bpl.Expr> { inSet, ct });
                        q = new Bpl.ForallExpr(ctor.tok, bvs, trigger, BplImp(inSet, Bpl.Expr.Lt(lhs, rhs)));
                        sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(180L, "Inductive set element rank")));
                    }
                    else if (argType is MultiSetType)
                    {
                        ...
                        CreateBoundVariables(ctor.Formals, out bvs, out args);
                        Bpl.Variable dVar = new Bpl.BoundVariable(arg.tok, new Bpl.TypedIdent(arg.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(181L, "d"), predef.DatatypeType));
                        bvs.Add(dVar);
                        Bpl.IdentifierExpr ie = new Bpl.IdentifierExpr(arg.tok, dVar);
                        var inMultiset = Bpl.Expr.SelectTok(arg.tok, args[i], FunctionCall(arg.tok, BuiltinFunction.Box, null, ie));
                        Bpl.Expr ante = Bpl.Expr.Gt(inMultiset, Bpl.Expr.Literal(MutateCSharp.Schemata488.ReplaceNumericConstant_2(182L, 0)));
                        Bpl.Expr lhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ie);
                        var ct = FunctionCall(ctor.tok, ctor.FullName, predef.DatatypeType, args);
                        var rhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ct);
                        var trigger = new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(186L, true), new List<Bpl.Expr> { inMultiset, ct });
                        q = new Bpl.ForallExpr(ctor.tok, bvs, trigger, BplImp(ante, Bpl.Expr.Lt(lhs, rhs)));
                        sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(187L, "Inductive multiset element rank")));
                    }
                    else if (argType is MapType)
                    {
                        var finite = ((MapType)argType).Finite;
                        {
                            ...
                            CreateBoundVariables(ctor.Formals, out bvs, out args);
                            var dVar = new Bpl.BoundVariable(arg.tok, new Bpl.TypedIdent(arg.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(188L, "d"), predef.DatatypeType));
                            bvs.Add(dVar);
                            ...
                            var ct = FunctionCall(ctor.tok, ctor.FullName, predef.DatatypeType, args);
                            var rhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ct);
                            var trigger = new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(189L, true), new List<Bpl.Expr> { inDomain, ct });
                            q = new Bpl.ForallExpr(ctor.tok, bvs, trigger, BplImp(inDomain, Bpl.Expr.Lt(lhs, rhs)));
                            sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(190L, "Inductive map key rank")));
                        }
                        {
                            ...
                            CreateBoundVariables(ctor.Formals, out bvs, out args);
                            var bxVar = new Bpl.BoundVariable(arg.tok, new Bpl.TypedIdent(arg.tok, MutateCSharp.Schemata488.ReplaceStringConstant_1(191L, "bx"), predef.BoxType));
                            bvs.Add(bxVar);
                            ...
                            var ct = FunctionCall(ctor.tok, ctor.FullName, predef.DatatypeType, args);
                            var rhs = FunctionCall(ctor.tok, BuiltinFunction.DtRank, null, ct);
                            var trigger = new Bpl.Trigger(ctor.tok, MutateCSharp.Schemata488.ReplaceBooleanConstant_0(192L, true), new List<Bpl.Expr> { inDomain, ct });
                            q = new Bpl.ForallExpr(ctor.tok, bvs, trigger, BplImp(inDomain, Bpl.Expr.Lt(lhs, rhs)));
                            sink.AddTopLevelDeclaration(new Bpl.Axiom(ctor.tok, q, MutateCSharp.Schemata488.ReplaceStringConstant_1(193L, "Inductive map value rank")));
                        }
                    }
                }
            }
        ...
        private void AddConstructorAxioms(DatatypeDecl dt, DatatypeCtor ctor, Bpl.Function ctorFunction, bool includeIsAllocAxiom)
        {
            ...
            CreateBoundVariables(ctor.Formals, out var bvs, out var args);
            bvs.InsertRange(MutateCSharp.Schemata488.ReplaceNumericConstant_2(194L, 0), tyvars);
        ...
        {
            var hVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(198L, "$h"), predef.HeapType, out var h);

            Bpl.Expr conj = Bpl.Expr.True;
            for (var i = MutateCSharp.Schemata488.ReplaceNumericConstant_2(199L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(203L, i, ctor.Formals.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(208L, ref i))
            {
                var arg = ctor.Formals[i];
        ...
        MutateCSharp.Schemata488.ReplaceStringConstant_1(209L, "Constructor $IsAlloc"));
        ...
        private void AddCommonIsAllocConstructorAxiom(DatatypeDecl dt)
        {
            ...
            var hVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(210L, "$h"), predef.HeapType, out var h);
...

            {
                ...
                var ax = new Bpl.Axiom(dt.tok, BplForall(Snoc(boundVariables, hVar), tr, body), MutateCSharp.Schemata488.ReplaceStringConstant_1(211L, "Datatype $IsAlloc"));
          ...
          out Bpl.Expr varExpression, out Bpl.Expr typeExpression, out Bpl.Expr isPredicate)
        {
            ...
            var dVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(212L, "d"), predef.DatatypeType, out varExpression);
        ...
        private void AddDestructorAxiom(DatatypeDecl dt, DatatypeCtor ctor, Bpl.Function ctorFunction, List<Variable> tyvars, Expr c_ty)
        {
            ...
            var hVar = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(213L, "$h"), predef.HeapType, out var h);
            for (int i = MutateCSharp.Schemata488.ReplaceNumericConstant_2(214L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(218L, i, ctor.Formals.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(223L, ref i))
            {
                var arg = ctor.Formals[i];
                var dtor = GetReadonlyField(ctor.Destructors[i]);
                var dBv = BplBoundVar(MutateCSharp.Schemata488.ReplaceStringConstant_1(224L, "d"), predef.DatatypeType, out var dId);
                var isGoodHeap = FunctionCall(ctor.tok, BuiltinFunction.IsGoodHeap, null, h);
                Bpl.Expr dtq = FunctionCall(ctor.tok, ctor.QueryField.FullSanitizedName, Bpl.Type.Bool, dId);
                ...
                for (int j = MutateCSharp.Schemata488.ReplaceNumericConstant_2(225L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(229L, j, dt.TypeArgs.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(234L, ref j))
                {
                    var tv = tyvars[j];
                ...
                bvs.Add(hVar);
                if (MutateCSharp.Schemata488.ReplaceBinExprOp_8(239L, tyvarsGprime.Count, MutateCSharp.Schemata488.ReplaceNumericConstant_2(235L, 0)))
                {
        ...
        MutateCSharp.Schemata488.ReplaceStringConstant_1(244L, "Destructor $IsAlloc"));
        ...
        {
            Bpl.Expr conj = Bpl.Expr.True;
            for (var i = MutateCSharp.Schemata488.ReplaceNumericConstant_2(245L, 0); MutateCSharp.Schemata488.ReplaceBinExprOp_4(249L, i, ctor.Formals.Count); MutateCSharp.Schemata488.ReplacePostfixUnaryExprOp_5(254L, ref i))
            {
                var arg = ctor.Formals[i];
      ...
      MutateCSharp.Schemata488.ReplaceStringConstant_1(255L, "Constructor $Is"));
        ...
        private Axiom CreateConstructorIdentifierAxiom(DatatypeCtor ctor, Expr c)
        {
            ...
            var axiom = new Bpl.Axiom(ctor.tok, BplForall(bvs, trigger, q), MutateCSharp.Schemata488.ReplaceStringConstant_1(256L, "Constructor identifier"));
            return axiom;
        }
    }
}
