...
{
    internal class Schemata492
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT492");
        ...
        internal static bool ReplaceBinExprOp_11(long mutantId, Microsoft.Dafny.Field argument1, object argument2)
        {
        ...
        internal static bool ReplaceBinExprOp_0(long mutantId, System.Collections.Generic.List<Microsoft.Boogie.Variable> argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static bool ReplaceBinExprOp_10(long mutantId, System.Collections.Generic.List<Microsoft.Dafny.BoundedPool> argument1, object argument2)
        {
            if (!ActivatedInRange(mutantId, mutantId + 0)) { return argument1 != argument2; }
            if (ActivatedMutantId.Value == mutantId + 0) { return argument1 == argument2; }
            return argument1 != argument2;
        ...
        internal static int ReplacePrefixUnaryExprOp_6(long mutantId, ref int argument1)
        {
            if (!ActivatedInRange(mutantId, mutantId + 3)) { return --argument1; }
            if (ActivatedMutantId.Value == mutantId + 0) { return +argument1; }
    ...
    public partial class BoogieGenerator
    {
        public class WFOptions
        {
            ...
            public Action<IToken, Bpl.Expr, PODesc.ProofObligationDescription, Bpl.QKeyValue> AssertSink(BoogieGenerator tran, BoogieStmtListBuilder builder)
            {
                return (t, e, d, qk) =>
                {
                    if (MutateCSharp.Schemata492.ReplaceBinExprOp_0(1L, Locals, null))
                    {
                        var b = BplLocalVar(tran.CurrentIdGenerator.FreshId(MutateCSharp.Schemata492.ReplaceStringConstant_1(2L, "b$reqreads#")), Bpl.Type.Bool, Locals);
        ...
        void CheckWellformedAndAssume(Expression expr, WFOptions wfOptions, List<Variable> locals, BoogieStmtListBuilder builder, ExpressionTranslator etran, string comment)
        {
            ...
            else if (expr is QuantifierExpr)
            {
                ...
                var body = Substitute(e.LogicalBody(MutateCSharp.Schemata492.ReplaceBooleanConstant_2(3L, true)), null, substMap);
        ...
        public record ReadsCheckDelayer(ExpressionTranslator etran, Function selfCallsAllowance,
                                       ...
                                       string resultDescription = null)
        {
            ...
            if (wfOptions.LValueContext)
            {
                ...
                wfOptions = wfOptions.WithLValueContext(MutateCSharp.Schemata492.ReplaceBooleanConstant_2(4L, false));
            }
            ...
            if (MutateCSharp.Schemata492.ReplaceBinExprOp_3(5L, result, null))
            {
                ...
                builder.Add(new CommentCmd(MutateCSharp.Schemata492.ReplaceStringConstant_1(6L, "CheckWellformedWithResult: any expression")));
          ...
          BoogieStmtListBuilder builder, ExpressionTranslator etran)
        {
            ...
            foreach (var missingCtor in me.MissingCases)
            {
                ...
                if (MutateCSharp.Schemata492.ReplaceBinExprOp_5(11L, newLocals.Count, MutateCSharp.Schemata492.ReplaceNumericConstant_4(7L, 0)))
                {
                ...
                b.Add(Assert(GetToken(me), Bpl.Expr.False, new PODesc.MatchIsComplete(MutateCSharp.Schemata492.ReplaceStringConstant_1(16L, "expression"), missingStr)));
            ...
            for (int i = me.Cases.Count; MutateCSharp.Schemata492.ReplaceBinExprOp_7(25L, MutateCSharp.Schemata492.ReplaceNumericConstant_4(17L, 0), MutateCSharp.Schemata492.ReplacePrefixUnaryExprOp_6(21L, ref i));)
            {
                MatchCaseExpr mc = me.Cases[i];
                BoogieStmtListBuilder b = new BoogieStmtListBuilder(this, options);
                Bpl.Expr ct = CtorInvocation(mc, me.Source.Type, etran, locals, b, NOALLOC, MutateCSharp.Schemata492.ReplaceBooleanConstant_2(30L, false));
                // generate:  if (src == ctor(args)) { assume args-is-well-typed; mc.Body is well-formed; assume Result == TrExpr(case); } else ...
                CheckWellformedWithResult(mc.Body, wfOptions, result, resultType, locals, b, etran, MutateCSharp.Schemata492.ReplaceStringConstant_1(31L, "match expression branch result"));
          ...
          BoogieStmtListBuilder builder, ExpressionTranslator etran)
        {
            ...
            if (etran.UsesOldHeap)
            {
                BuildWithHeapAs(stmtExpr.S.Tok, etran.HeapExpr, MutateCSharp.Schemata492.ReplaceStringConstant_1(32L, "StmtExpr#"), locals, builder,
            ...
            CheckWellformedWithResult(stmtExpr.E, options, result, resultType, locals, builder, etran, MutateCSharp.Schemata492.ReplaceStringConstant_1(33L, "statement expression result"));
        }
          ...
          BoogieStmtListBuilder builder, System.Action build)
        {
            ...
            var tmpHeapVar = new Bpl.LocalVariable(token, new Bpl.TypedIdent(token, MutateCSharp.Schemata492.ReplaceStringConstant_1(34L, "Heap$") + suffix, predef.HeapType));
          ...
          string whatKind, List<MemberDecl> members, List<DatatypeCtor> candidateCtors, BoogieStmtListBuilder builder, ExpressionTranslator etran)
        {
            if (inCompiledContext)
            {
                ...
                if (MutateCSharp.Schemata492.ReplaceBinExprOp_5(39L, enclosingGhostConstructors.Count, MutateCSharp.Schemata492.ReplaceNumericConstant_4(35L, 0)))
                {
                    ...
                    builder.Add(Assert(GetToken(exprUsedForToken), notGhostCtor,
                      new PODesc.NotGhostVariant(whatKind,
                        Util.PrintableNameList(members.ConvertAll(member => member.Name), MutateCSharp.Schemata492.ReplaceStringConstant_1(44L, "and")),
          ...
          List<Bpl.Variable> locals, BoogieStmtListBuilder builder, ExpressionTranslator etran)
        {
            ...
            if (expr.Function.Name is "RotateLeft" or "RotateRight")
            {
                ...
                var arg = expr.Args[MutateCSharp.Schemata492.ReplaceNumericConstant_4(45L, 0)];
                builder.Add(Assert(GetToken(expr), Bpl.Expr.Le(Bpl.Expr.Literal(MutateCSharp.Schemata492.ReplaceNumericConstant_4(49L, 0)), etran.TrExpr(arg)), new PODesc.ShiftLowerBound(MutateCSharp.Schemata492.ReplaceBooleanConstant_2(53L, false), arg), options.AssertKv));
                builder.Add(Assert(GetToken(expr), Bpl.Expr.Le(etran.TrExpr(arg), Bpl.Expr.Literal(w)), new PODesc.ShiftUpperBound(w, MutateCSharp.Schemata492.ReplaceBooleanConstant_2(54L, false), arg),
                  options.AssertKv));
            }
        }
          ...
          BoogieStmtListBuilder builder, ExpressionTranslator etran, bool checkRhs)
        {
            if (e.Exact)
            {
                var substMap = SetupBoundVarsAsLocals(e.BoundVars.ToList<BoundVar>(), builder, locals, etran, MutateCSharp.Schemata492.ReplaceStringConstant_1(55L, "#Z"));
                Contract.Assert(e.LHSs.Count == e.RHSs.Count);  // checked by resolution
                var varNameGen = CurrentIdGenerator.NestedFreshIdGenerator(MutateCSharp.Schemata492.ReplaceStringConstant_1(56L, "let#"));
                for (int i = MutateCSharp.Schemata492.ReplaceNumericConstant_4(57L, 0); MutateCSharp.Schemata492.ReplaceBinExprOp_8(61L, i, e.LHSs.Count); MutateCSharp.Schemata492.ReplacePostfixUnaryExprOp_9(66L, ref i))
                {
                    var pat = e.LHSs[i];
                    var rhs = e.RHSs[i];
                    var nm = varNameGen.FreshId(string.Format(MutateCSharp.Schemata492.ReplaceStringConstant_1(67L, "#{0}#"), i));
                    ...
                    CheckWellformedWithResult(e.RHSs[i], wfOptions, rIe, pat.Expr.Type, locals, builder, etran, MutateCSharp.Schemata492.ReplaceStringConstant_1(68L, "let expression binding RHS well-formed"));
                    CheckCasePatternShape(pat, rIe, rhs.tok, pat.Expr.Type, builder);
                    var substExpr = Substitute(pat.Expr, null, substMap);
                    builder.Add(TrAssumeCmdWithDependenciesAndExtend(etran, e.tok, substExpr, e => Bpl.Expr.Eq(e, rIe), MutateCSharp.Schemata492.ReplaceStringConstant_1(69L, "let expression binding")));
                }
                CheckWellformedWithResult(Substitute(e.Body, null, substMap), wfOptions, result, resultType, locals, builder, etran, MutateCSharp.Schemata492.ReplaceStringConstant_1(70L, "let expression result"));
            ...
            else
            {
                ...
                var rhs = Substitute(e.RHSs[MutateCSharp.Schemata492.ReplaceNumericConstant_4(71L, 0)], null, substMap);
                if (checkRhs)
                {
                    ...
                    GenerateAndCheckGuesses(e.tok, lhsVars, bounds, e.RHSs[MutateCSharp.Schemata492.ReplaceNumericConstant_4(75L, 0)], TrTrigger(etran, e.Attributes, e.tok), builder, etran);
                }
                // assume typeAntecedent(b);
                ...
                if (MutateCSharp.Schemata492.ReplaceBinExprOp_10(79L, e.Constraint_Bounds, null))
                {
                    ...
                    var rhs_prime = Substitute(e.RHSs[MutateCSharp.Schemata492.ReplaceNumericConstant_4(80L, 0)], null, nonGhostMap_prime);
                    ...
                    builder.Add(TrAssumeCmdWithDependencies(etran, e.tok, rhs_prime, MutateCSharp.Schemata492.ReplaceStringConstant_1(84L, "assign-such-that constraint")));
                    ...
                    builder.Add(Assert(GetToken(e), etran.TrExpr(eq),
                      new PODesc.LetSuchThatUnique(e.RHSs[MutateCSharp.Schemata492.ReplaceNumericConstant_4(85L, 0)], e.BoundVars.ToList())));
                }
                ...
                if (MutateCSharp.Schemata492.ReplaceBinExprOp_3(89L, result, null))
                {
                    Contract.Assert(resultType != null);
                    var bResult = etran.TrExpr(letBody);
                    CheckSubrange(letBody.tok, bResult, letBody.Type, resultType, builder);
                    builder.Add(TrAssumeCmdWithDependenciesAndExtend(etran, e.tok, letBody, e => Expr.Eq(result, e), MutateCSharp.Schemata492.ReplaceStringConstant_1(90L, "let expression")));
                    builder.Add(TrAssumeCmd(letBody.tok, etran.CanCallAssumption(letBody)));
                    builder.Add(new CommentCmd(MutateCSharp.Schemata492.ReplaceStringConstant_1(91L, "CheckWellformedWithResult: Let expression")));
        ...
        void CheckFrameWellFormed(WFOptions wfo, List<FrameExpression> fes, List<Variable> locals, BoogieStmtListBuilder builder, ExpressionTranslator etran)
        {
            ...
            foreach (var fe in fes)
            {
                ...
                if (MutateCSharp.Schemata492.ReplaceBinExprOp_12(93L, () => MutateCSharp.Schemata492.ReplaceBinExprOp_11(92L, fe.Field, null), () => fe.E.Type.IsRefType))
                {
          ...
          Bpl.IdentifierExpr/*?*/ nw, BoogieStmtListBuilder builder, ExpressionTranslator etran, WFOptions options)
        {
            ...
            var varNameGen = CurrentIdGenerator.NestedFreshIdGenerator(forArray ? MutateCSharp.Schemata492.ReplaceStringConstant_1(99L, "arrayinit#") : MutateCSharp.Schemata492.ReplaceStringConstant_1(100L, "seqinit#"));
            var bvs = new List<Bpl.Variable>();
            var indices = new List<Bpl.Expr>();
            for (var i = MutateCSharp.Schemata492.ReplaceNumericConstant_4(101L, 0); MutateCSharp.Schemata492.ReplaceBinExprOp_8(105L, i, dims.Count); MutateCSharp.Schemata492.ReplacePostfixUnaryExprOp_9(110L, ref i))
            {
                var nm = varNameGen.FreshId(string.Format(MutateCSharp.Schemata492.ReplaceStringConstant_1(111L, "#i{0}#"), i));
                var bv = new Bpl.BoundVariable(tok, new Bpl.TypedIdent(tok, nm, Bpl.Type.Int));
                bvs.Add(bv);
                var ie = new Bpl.IdentifierExpr(tok, bv);
                indices.Add(ie);
                ante = BplAnd(ante, BplAnd(Bpl.Expr.Le(Bpl.Expr.Literal(MutateCSharp.Schemata492.ReplaceNumericConstant_4(112L, 0)), ie), Bpl.Expr.Lt(ie, etran.TrExpr(dims[i]))));
            }

            var sourceType = init.Type.AsArrowType;
            Contract.Assert(sourceType.Args.Count == dims.Count);
            var args = Concat(
              Map(Enumerable.Range(MutateCSharp.Schemata492.ReplaceNumericConstant_4(116L, 0), dims.Count), ii => TypeToTy(sourceType.Args[ii])),
            ...
            var desc = new PODesc.IndicesInDomain(forArray ? MutateCSharp.Schemata492.ReplaceStringConstant_1(120L, "array") : MutateCSharp.Schemata492.ReplaceStringConstant_1(121L, "sequence"));
            builder.Add(AssertNS(tok, q, desc));
            if (MutateCSharp.Schemata492.ReplaceBinExprOp_12(122L, () => !forArray, () => options.DoReadsChecks))
            {
                // check read effects
                Type objset = program.SystemModuleManager.ObjectSetType();
                Expression wrap = new BoogieWrapper(
                  FunctionCall(tok, Reads(MutateCSharp.Schemata492.ReplaceNumericConstant_4(128L, 1)), TrType(objset), args),
                  objset);
                ...
                CheckFrameSubset(tok, new List<FrameExpression> { reads }, null, null,
                  ...
                  new PODesc.ReadFrameSubset(MutateCSharp.Schemata492.ReplaceStringConstant_1(132L, "invoke the function passed as an argument to the sequence constructor")),
                  options.AssertKv);
            }
            ...
            if (MutateCSharp.Schemata492.ReplaceBinExprOp_3(133L, cre, null))
            {
            ...
            if (forArray)
            {
                ...
                var tr = new Bpl.Trigger(tok, MutateCSharp.Schemata492.ReplaceBooleanConstant_2(134L, true), new List<Bpl.Expr> { ai });
