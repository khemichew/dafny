...
{
    internal class Schemata507
    {
        private static readonly System.Lazy<long> ActivatedMutantId =
          new System.Lazy<long>(() =>
          {
              var activatedMutant = System.Environment.GetEnvironmentVariable("MUTATE_CSHARP_ACTIVATED_MUTANT507");
...
namespace DafnyCore.Verifier
{
    ...
    public abstract class ProofDependency
    {
        ...
        public string LocationString()
        {
            ...
            {
                return MutateCSharp.Schemata507.ReplaceStringConstant_0(1L, "<no location>");
            }
        ...
        public string RangeString()
        {
            if (Range?.StartToken is null)
            {
                return MutateCSharp.Schemata507.ReplaceStringConstant_0(2L, "<no range>");
            }
            var fn = Range.StartToken.filename;
            var sl = Range.StartToken.line;
            var sc = Range.StartToken.col;
    ...
    public class ProofObligationDependency : ProofDependency
    {
        ...
        {
            Range = BoogieGenerator.ToDafnyToken(MutateCSharp.Schemata507.ReplaceBooleanConstant_1(3L, true), tok).ToRange();
    ...
    public class EnsuresDependency : ProofDependency
    {
        ...
        public override string Description => MutateCSharp.Schemata507.ReplaceStringConstant_0(4L, "ensures clause");
    ...
    public class AssignmentDependency : ProofDependency
    {
        ...
        public override string Description => MutateCSharp.Schemata507.ReplaceStringConstant_0(5L, "assignment (or return)");
